...
#   filename:  https://raw.githubusercontent.com/oasis-open/cti-stix2-json-schemas/master/schemas/sdos/course-of-action.json
#   timestamp: 2021-06-14T12:50:25+00:00
...
class MitigationDTO(Core):
    ...
    name: Optional[str] = Field(
        None, description='The name used to identify the Course of Action.'
    )
